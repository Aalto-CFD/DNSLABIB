...
Beta = CreateBlock(6.11,Ly/2,Lz/2,0.42,Ly,Lz,x,y,z,dx,dy,dz,Nx,Ny,Nz,Beta);
Beta = CreateInverseBlock(6.11,2.25,Lz/2,0.42,0.9,Lz,x,y,z,dx,dy,dz,Nx,Ny,Nz,Beta);
Beta = CreateBlock(2.5857,4.59,Lz/2,4.5714,0.42,Lz,x,y,z,dx,dy,dz,Nx,Ny,Nz,Beta);
