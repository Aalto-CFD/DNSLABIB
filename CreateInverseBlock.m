function Beta = CreateInverseBlock(XCenter,YCenter,ZCenter,DimX,DimY,DimZ,x,y,z,dx,dy,dz,Nx,Ny,Nz,Beta)
...
Beta(DefIyMinus:DefIyPlus,DefIxMinus:DefIxPlus,DefIzMinus:DefIzPlus) = 1.0;
